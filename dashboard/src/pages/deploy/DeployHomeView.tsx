...
import { buildDeploymentListHref } from '@/pages/deploy/deploy-utils'
...
type DeployHomeViewProps<TDeployment extends LatestDeploymentItem> = {
...
export function DeployHomeView<TDeployment extends LatestDeploymentItem>({
  prefillLoading,
  prefillMode,
  prefillAppName,
  prefillAppId,
  ...
  onOpenDeployment,
  renderActionMenu,
}: DeployHomeViewProps<TDeployment>) {
  return (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          ...
          <Button variant="outline" size="sm" asChild>
            <a href={buildDeploymentListHref()}>View deployment list</a>
          </Button>
        </CardHeader>
        <CardContent>
          {loading ? (
