    ...
    >
            ...
            {filteredServers.map(s => (
              ...
              >
                <div className="min-w-0 flex flex-col gap-0.5">
                  <span className={cn('text-sm truncate', s.id === serverId && 'font-medium')}>
                    {s.name || s.host || s.id}
                  </span>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <div className="grid grid-cols-2 gap-1 p-1 min-w-[180px]">
                  ...
                  >
                    <PanelsLeftRight className="h-4 w-4 mr-2" />
                    70 / 30
                  </Button>
                  <Button
                    variant="ghost"
      ...
      <Dialog open={reconnectConfirmOpen} onOpenChange={setReconnectConfirmOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setReconnectConfirmOpen(false)}>
              Cancel
            </Button>
      ...
      >
        ...
        >
          ...
          <div
            className={cn('absolute z-10 left-2 bottom-2', sidePanel !== 'none' && 'opacity-90')}
          >
            <div className="flex items-center gap-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="start"
                  className="w-[360px] max-h-[300px] overflow-y-auto"
                >
