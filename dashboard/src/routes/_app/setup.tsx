...
function SetupPage() {
  ...
  useEffect(() => {
    ...
    if (countdown <= 0) {
      ...
      pb.collection('_superusers').authWithPassword(e, p)
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="w-full max-w-md p-8 bg-card rounded-lg shadow-md border border-border text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 text-card-foreground">Account Created Successfully!</h2>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background">
      <div className="w-full max-w-md p-8 bg-card rounded-lg shadow-md border border-border">
        <h2 className="text-2xl font-bold text-center mb-2 text-card-foreground">Welcome to Websoft9</h2>
