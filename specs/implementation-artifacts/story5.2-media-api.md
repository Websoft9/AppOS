...
3. **Verification Command**:
   ```bash
   curl http://127.0.0.1:9000/media/catalog_en.json
...
- `curl http://127.0.0.1:9000/media/catalog_en.json` returns 404 or 502
...
curl -I http://127.0.0.1:9000/media/logos/wordpress.png
...
curl http://127.0.0.1:9000/media/catalog_en.json
curl http://127.0.0.1:9000/media/product_en.json
curl http://127.0.0.1:9000/media/logos/  # Should return 404 or index
```

**Development Testing**:
```bash
# 1. Verify static files served by nginx
curl -I http://127.0.0.1:9000/media/catalog_en.json
...
echo '"proxy": "http://127.0.0.1:9000"' >> package.json
npm start

# Option B: Use .env file
echo 'REACT_APP_MEDIA_URL=http://127.0.0.1:9000/media' > .env
npm start
...
- Verify: `curl -I http://127.0.0.1:9000/media/catalog_en.json` should NOT include `X-Powered-By: FastAPI`
...
- Solution: Add `"proxy": "http://127.0.0.1:9000"` to package.json or use .env
...
- [ ] Static JSON accessible: `curl http://127.0.0.1:9000/media/catalog_en.json` returns JSON
...
- [ ] Container mode (`http://127.0.0.1:9000/store`): Works
