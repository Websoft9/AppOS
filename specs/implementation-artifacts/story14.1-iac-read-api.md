...
- [x] `backend/domain/routes/iac.go` created and registered in `routes.go`; the file route sub-group binds `apis.RequireSuperuserAuth()`; write/upload/download endpoints stubbed as `501`
