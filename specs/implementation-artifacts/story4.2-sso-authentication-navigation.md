...
### URL Structure
- **Cockpit Plugin**: `http://127.0.0.1:9091/portainer`
- **Portainer Base**: `http://hostname:81/w9deployment/`
- **Deep Links**: `http://127.0.0.1:9091/portainer#/w9deployment/#!/containers`
...
# 4. Test deep linking
# Browser: http://127.0.0.1:9091/portainer#/w9deployment/#!/containers
...
curl -X POST "http://127.0.0.1:${NGINX_PORT}/w9deployment/api/auth" \
