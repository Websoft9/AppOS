...
- [x] AC2: Secrets list page displays: name, template_id (with label), scope, access_mode, status, last_used_at, last_used_by. No raw secret value shown.
...
- [x] Task 2: Secrets list page (`/admin/credentials/secrets`)
  - [x] 2.1 Table with columns per AC2
