...
func (f *fakeSoftwareExecutor) Repair(context.Context, string, software.ResolvedTemplate) (software.SoftwareComponentDetail, error) {
	return f.installDetail, f.installErr
}

// TestSoftwareTaskTypeValues verifies that the four software delivery task type constants
