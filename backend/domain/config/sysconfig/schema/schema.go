...
var entryCatalog = []EntrySchema{
	...
	},
	{
		...
		Key:     "scheduling",
		Fields: []FieldSchema{
			{ID: "reachabilityIntervalMinutes", Label: "Reachability Interval Minutes", Type: "integer", HelpText: "Effective interval for instance, AI provider, and connector reachability sweeps. Range: 60-1440 minutes in 60-minute steps. Raw cron ticks run hourly."},
			{ID: "metricsFreshnessIntervalMinutes", Label: "Metrics Freshness Interval Minutes", Type: "integer", HelpText: "Effective interval for metrics freshness evaluation. Range: 1-1440 minutes."},
			{ID: "controlReachabilityIntervalMinutes", Label: "Control Reachability Interval Minutes", Type: "integer", HelpText: "Effective interval for server reachability sweeps. Range: 1-1440 minutes."},
			{ID: "runtimeSnapshotIntervalMinutes", Label: "Runtime Snapshot Interval Minutes", Type: "integer", HelpText: "Effective interval for runtime snapshot pulls. Range: 1-1440 minutes."},
			{ID: "credentialSweepIntervalMinutes", Label: "Credential Sweep Interval Minutes", Type: "integer", HelpText: "Effective interval for credential sweeps. Range: 1-1440 minutes."},
			{ID: "appHealthIntervalMinutes", Label: "App Health Interval Minutes", Type: "integer", HelpText: "Effective interval for app health sweeps. Range: 1-1440 minutes."},
			{ID: "factsPullIntervalMinutes", Label: "Facts Pull Interval Minutes", Type: "integer", HelpText: "Effective interval for facts pulls. Range: 1-1440 minutes."},
		},
	},
	{
		ID:      "monitor-policy",
