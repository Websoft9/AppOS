...
func TestInt_Float64(t *testing.T) {
	...
	if got := sysconfig.Int(g, "maxSizeMB", 0); got != 42 {
...
func TestInt_Int(t *testing.T) {
	...
	if got := sysconfig.Int(g, "n", 0); got != 7 {
...
func TestInt_Missing(t *testing.T) {
	g := map[string]any{}
	if got := sysconfig.Int(g, "missing", 99); got != 99 {
...
func TestInt_Nil(t *testing.T) {
	...
	if got := sysconfig.Int(g, "n", 5); got != 5 {
...
func TestString_Present(t *testing.T) {
	...
	if got := sysconfig.String(g, "host", ""); got != "smtp.example.com" {
...
func TestString_Missing(t *testing.T) {
	g := map[string]any{}
	if got := sysconfig.String(g, "host", "default"); got != "default" {
...
func TestString_WrongType(t *testing.T) {
	...
	if got := sysconfig.String(g, "host", "fb"); got != "fb" {
...
func TestInt_StringNumeric(t *testing.T) {
	...
	if got := sysconfig.Int(g, "n", 0); got != 42 {
...
func TestInt_StringInvalid(t *testing.T) {
	...
	if got := sysconfig.Int(g, "n", 99); got != 99 {
