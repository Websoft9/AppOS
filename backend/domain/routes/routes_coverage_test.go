...
var (
	...
	reSpecPathKey       = regexp.MustCompile(`^  (/(?:api/ext|api/servers|api/terminal|api/actions|api/pipelines|api/releases|api/exposures|api/apps|api/components|api/catalog)[^\s:]*):\s*$`)
)
