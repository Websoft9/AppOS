...
func EnsureAppExposuresCollection(app core.App) error {
	appInstances, err := app.FindCollectionByNameOrId("app_instances")
	if err != nil {
		return err
	}
	appReleases, err := app.FindCollectionByNameOrId("app_releases")
	if err != nil {
		return err
	}
	...
	return ensureAppInstanceRelationField(app, "primary_exposure", col)
}
