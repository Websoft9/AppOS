...
func init() {
	m.Register(func(app core.App) error {
		...
		col.Fields.Add(&core.SelectField{Name: "visibility", Required: true, MaxSelect: 1, Values: []string{"private", "shared"}})
		...
		col.Indexes = []string{"CREATE UNIQUE INDEX idx_store_custom_apps_key ON store_custom_apps (key)"}
		return app.Save(col)
